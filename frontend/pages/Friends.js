...
export default function App() {
  ...
  useEffect(() => {
    axios
      .post(`http://localhost:8000/api/users/1/add_friend/${member}`, {
        user_id: 1,
        friend_id: member,
      })
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .post(`http://localhost:8000/api/groups/1/create_group/`, {
        user_id: 1,
        group_name: groupName,
      })
      .then((response) => {
        setGorupName(response);
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/api/users/0/friends")
      .then((response) => {
