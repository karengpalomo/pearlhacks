  ...
  useEffect(() => {
    axios
      .post("http://localhost:8000/api/search", {
        ...
        availability: [Filter.formattedDate, Filter.timeofday],
        prices: Filter.budget,
        longitude: Filter.longtitude,
        ...
        <View style={styles.place}>
          <View style={styles.placeContainer}>
            <View style={styles.left}>
              <Text style={styles.header1}>{placeNames[0]}</Text>
              <View style={styles.description}>
                <Text style={styles.descripText}>{placeDescription[0]}</Text>
              </View>
              <Text>{placeAddresses[0]}</Text>
              <Text>
                {placeCities[0]}, {placeStates[0]} {placeZips[0]}
              </Text>
          ...
          <View style={styles.bottom}>
            <View style={styles.tags}>
              <Text style={styles.tagText}>{placeTags[0]}</Text>
            </View>
